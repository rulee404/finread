...
export default function CheckoutSuccessPage() {
  return (
    <div className="mx-auto flex min-h-[60vh] max-w-sm flex-col items-center justify-center px-5 py-16 text-center">
      ...
      <h1 className="mb-2 text-2xl font-bold text-ink">支付成功！</h1>
      ...
      <div className="flex gap-3">
        <Link
          href="/"
          className="rounded-lg border border-border bg-surface2 px-5 py-2.5 text-sm text-text transition-colors hover:bg-wash-hover"
        >
          返回首页
        </Link>
        <Link
